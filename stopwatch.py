try:
	...
	class stop_watch():
		def __init__(self):
			...
			self.silence_btn_img = Image.open('silence.png')
			...
			self.nsound_btn_img = Image.open('sound.png')
			...
			self.sound_on_btn_img = Image.open('speaker.png')
			...
			self.sound_off_btn_img = Image.open('mute1.png')
