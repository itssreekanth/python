...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=102603&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&subId=[SUBID_ENCODED]&vp_content=plembed19d5lgvskhtr&cbuster=1600092548',
					origQString: 's=102603&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&subId=[SUBID_ENCODED]&vp_content=plembed19d5lgvskhtr',
					placementId: 102603,
					x: 600,
					y: 338,
					videoType: 'flow',
					...
					floatConfig: {
						...
						direction: 'bl', verticalOffset: 5,
						horizontalOffset: 5, isCloseBtn: 1,
						flowMode: 'below', closeBtnPos: 'left'
					},
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Linux","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"84.0.4147.89","browserVersionMajor":"84","browserVersionMinor":"0"},"browser":"chrome","os":"linux","osVer":"","deviceType":"desktop"},
					isFpCookie: 0,
					geo: 'IN',
					dmaCode: 0,
					dynamicSetup: [],
