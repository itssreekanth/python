...
(function(){
    ...
    (function() {
    var p = "4214881", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_4214881||'',
    guid:window.ftGUID_4214881||'',
    confID:window.ftConfID_4214881||'0',
    ftReturn: window.ftReturn_4214881||'',
    keyword:window.ftKeyword_4214881||'',
    ftId:window.ftId_4214881||'',
    ftImpId:window.ftImp4214881 && window.ftImp4214881.impID || '',
    campaignID: '115843',
    cID:'100966',
    pID:'4214881',
    creativeID:'2600614',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115843&sid=18330&plc=4214881&num=&adid=&advid=&adsrv=29&btreg=4214881&btadsrv=flashtalking&crt=2600614&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ['http://servedby.flashtalking.com/click/8/115843;4214881;2600614;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?157758357-4214881;2600614;',
    centreAd: true,
    width:728,
    height:90,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/421/4214881/2600614/image/2600614.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115843;4214881;202;pixel;DV360;DV360FY20CCBEHAffinityINDSKBAN728x90/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/115843;4214881;2600614;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display',
    divID:'ftdiv4214881',
    altimgID:'ftalt4214881',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4214881 && parseInt(window.ftImp4214881.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4214881') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m4214881'),
    pageVisible: 'maybe',
